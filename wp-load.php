...
define('I_WP_CONFIG', ABSPATH . 'sites/' . $_SERVER['SERVER_NAME'] .'/wp-config.php' );
define('I_WP_CONTENT', ABSPATH . 'sites/' . $_SERVER['SERVER_NAME'] . '/wp-content' );

if ( file_exists( I_WP_CONFIG ) ) {
